...
class SpringIntegrationTestsApplicationTests {
	...
	user.setId(1);
	mockMvc.perform(MockMvcRequestBuilders.post("/updateUser").contentType(MediaType.APPLICATION_JSON)
	...
	for (UserModel user : responseUsers) {
	    org.junit.jupiter.api.Assertions
		    .assertTrue(user.getUsername().equals("anujgupta") || user.getUsername().equals("charu"));
	    org.junit.jupiter.api.Assertions.assertTrue(user.getDept().equals("IT") || user.getDept().equals("MISC"));
	    org.junit.jupiter.api.Assertions
		    .assertTrue(user.getSalary().equals(52000) || user.getSalary().equals(40000));
	}
    }
	...
	ResultActions resultActions = mockMvc.perform(postRequest).andExpect(MockMvcResultMatchers.status().isOk())
		.andDo(MockMvcResultHandlers.print());
	...
	for (UserModel user : responseUsers) {
	    org.junit.jupiter.api.Assertions
		    .assertTrue(user.getUsername().equals("anujgupta") || user.getUsername().equals("harsha"));
	    org.junit.jupiter.api.Assertions.assertTrue(user.getDept().equals("IT"));
	    org.junit.jupiter.api.Assertions
		    .assertTrue(user.getSalary().equals(52000) || user.getSalary().equals(80000));
	}
    }
	...
	mockMvc.perform(requestBuilder).andExpect(matcher)
